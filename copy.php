...
$query_Recordset1 = "SELECT * FROM simpledom";
...
<table width="50%" border="1" align="center">
  <tr>
    <td colspan="2" class="ssss">蘋果焦點新聞</td>
  </tr>
  <?php do { ?>
    <tr>
      <td colspan="2" class="pppp"><?php echo $row_Recordset1['title']; ?></td>
      
    </tr>
    <tr>
      <td><?php echo $row_Recordset1['content']; ?></td>
     
      <td ><?php if ($row_Recordset1['picture'] !="無") { // Show if recordset not empty ?>
  <img src='img/<?php echo $row_Recordset1['picture']; ?>' width="360" hight="360">
